...
Public Class AdminBookInfo
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            If dbDataReader.HasRows Then
                While dbDataReader.Read
                    ...
                    txtPubYear.Text = dbDataReader("Publication_Year".ToString)
    ...
    Private Sub btnTranscation_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnTransaction.Click
